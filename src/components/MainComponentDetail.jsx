  ...
  return (
    ...
    >
      <div className="p-4 md:p-12 text-center lg:text-left">
        ...
        <h1 className="text-3xl font-bold pt-8 lg:pt-0">My Name</h1>
        ...
        <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center gap-7">
          <a className="link" href="https://github.com/BRicsi99">
            <FaGithub size="2rem" className="h-8 fill-current text-gray-600 hover:text-green-700"/>
          </a>
          <a className="link" href="https://gitlab.com/bardosrichard99">
            <AiFillGitlab size="2rem" className="h-8 fill-current text-gray-600 hover:text-green-700"/>
          </a>
          <a className="link" href="https://www.linkedin.com/in/richard-bardos/">
          <FaLinkedin size="2rem" className="h-8 fill-current text-gray-600 hover:text-green-700"/>
        </a>
        </div>
      </div>
    </div>
