    ...
    <>
      <div className="h-144 w-full lg:w-2/5 bg-white lg:rounded-lg">
        ...
        <div>
          ...
          <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-center gap-7">
          ...
          <div className="mt-12 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-center gap-7">
